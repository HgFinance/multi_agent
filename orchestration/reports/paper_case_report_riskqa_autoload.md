...
| Workflow run | `wf-20260803T054025Z-66ecc65f` |
| Execution mode | `paper` |
| Workflow status | `COMPLETED` |
| Binding decision | **`HOLD / ESCALATE`** |
| Binding | `False` |
| Generated at | `2026-08-03T05:40:47.548016+00:00` |
...
| risk | risk-management | PAPER_DOMAIN_PASS | `order_intent` → `risk_decision` | No | REJECT | paper_department=risk status=COMPLETED output=risk_decision binding=False external_writes=false |
...
|---|---|---|---|---|
| Risk | COMPLETED | LangGraph=True; executed=market-liquidity-risk-agent, pre-trade-risk-analyst; failed=—; not_executed=risk-supervisor, derivatives-margin-risk-agent, compliance-policy-agent, operational-counterparty-risk-agent | gpt-5.6-luna / not_called | — |
