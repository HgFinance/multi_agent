...
def build_default_registry() -> IndicatorRegistry:
    ...
    definitions = [
        ...
        _local("ENVELOPE", aliases=("엔빌로프", "엔벨로프", "봉투선", "ENVELOPES"), category="VOLATILITY", outputs={"UPPER": ValueUnit.PRICE, "MIDDLE": ValueUnit.PRICE, "LOWER": ValueUnit.PRICE}, defaults={"PERIOD": 20, "PERCENT": Decimal("2")}, integer_parameters=period, warmup_bars=lambda p: int(p["PERIOD"])),
