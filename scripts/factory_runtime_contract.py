...
CRITICAL_FILES = (
    ...
    "departments/01-research/contracts/alpha_ast_surface.py",
    ...
    "departments/01-research/factory/formula_evolution_engine.py",
    "departments/01-research/factory/formula_breeder.py",
    "departments/01-research/factory/formula_search_memory.py",
    "departments/01-research/factory/evolution_candidate_intake.py",
    "departments/01-research/factory/alpha_evolution.py",
    ...
    "departments/04-quant-backtest/pipeline/pbo_cscv.py",
    ...
    "departments/04-quant-backtest/pipeline/walk_forward.py",
)
