...
| 항목 | 값 |
|---|---|
| **qa_decision_id** | `3278804c-0ae8-4227-9d0e-f29b9eef387b` |
| **판정 (verdict)** | **PASS** |
| **판정 엔진** | departments/06-ai-qa-audit/evidence/evidence_qa_engine.py (`qa-evidence-p0-v1`) |
| **input_hash** | `9ded4e203d39dcebd6c5809ba0e8296256ee60b4e21f6e63eba40c381165f61a` (같은 Artifact·Context면 재현 가능) |
| **decision_time (PIT)** | 2026-08-03T00:25:50.533200+00:00 |
| **escalate** | True |
| **생성** | qa-department-pipeline-v1, 2026-08-03T00:26:08.546205+00:00 |
...
QA Supervisor Agent를 사용할 수 없어 결정론적 QA 판정만 유지했습니다 (RuntimeError). 원본 부서와 독립 검토자에게 수동 확인을 요청합니다.
...
| 필드 | 값 |
|---|---|
| trace_id | `f67f33df-089d-4fd9-a920-ec23abd0bd1b` |
...
| 단계 | 오류 | 조치 |
|---|---|---|
| supervisor | RuntimeError | ESCALATE |

## Notion 업로드 (Reporter Node)

업로드 성공: https://app.notion.com/p/qa_decision_id-3278804c-0ae8-4227-9d0e-f29b9eef387b-3b1c2ded568081508493c7eefd517517
