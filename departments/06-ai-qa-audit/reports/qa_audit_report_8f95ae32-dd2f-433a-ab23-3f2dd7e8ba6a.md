...
| 항목 | 값 |
|---|---|
| **qa_decision_id** | `8f95ae32-dd2f-433a-ab23-3f2dd7e8ba6a` |
| **판정 (verdict)** | **PASS** |
| **판정 엔진** | departments/06-ai-qa-audit/evidence/evidence_qa_engine.py (`qa-evidence-p0-v1`) |
| **input_hash** | `2ebe60ff9f6238d7fc87117fbdf08366e5ea300352fceb6d2c1e723c29173ce9` (같은 Artifact·Context면 재현 가능) |
| **decision_time (PIT)** | 2026-08-02T17:21:13.557613+00:00 |
| **escalate** | True |
| **생성** | qa-department-pipeline-v1, 2026-08-02T17:21:15.420943+00:00 |
...
| 필드 | 값 |
|---|---|
| trace_id | `4b361691-6808-4c16-8a0c-63782df7dab0` |
