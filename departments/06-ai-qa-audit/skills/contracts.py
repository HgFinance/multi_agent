"""Typed contracts for AI-QA Worker skills and tool boundaries."""
...
class QASkillContext(BaseModel):
    """Execution context shared by every QA Skill."""
...
class QASkillResult(BaseModel):
    """Structured result; degraded or escalated is never a QA pass."""
