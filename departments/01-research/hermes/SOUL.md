...
- Use the local `market-api` snapshot and `departments/01-research/collectors/news.py` before making any additional external data request; never rely on an unversioned local fixture
