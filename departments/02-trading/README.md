...
직원 런타임은 독립 LangGraph Worker와 Ollama `qwen3:8b`이며 Hermes Profile은 `trading-department`다. `Modelfile`은 로컬 보조 실행용이고, Build·Eval·권한 기준은 [Ollama Department Modelfile Guide](../../docs/02-engineering/OLLAMA_DEPARTMENT_MODELFILE_GUIDE.md)를 따른다.
