...
def main() -> int:
    ...
    parser.add_argument("--query", required=True, help="The compliance question or proposed order to check")
    ...
    result = run_compliance_check(query=args.query, as_of=args.as_of, corpus_dir=corpus_dir)
