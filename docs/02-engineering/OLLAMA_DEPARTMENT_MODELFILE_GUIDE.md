...
> 현재 구현 범위는 LLM Worker 기준 CEO 1, HR 5, Research 6, Trading 2, Risk 1, Quant/Backtest 7, Accounting/Portfolio 8, AI QA 2이며, 결정론 runner(`desk-runner`, `risk-runner`, `qa-runner`) 3명을 더해 총 35명이다. `Modelfile`은 보조 alias 정의이며, 실제 직원 수의 Source of Truth가 아니다.
>
