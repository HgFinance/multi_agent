...
초기 Migration은 10개 내부 업무 Schema, 149개 Table과 제한된 `api` View/RPC를 만든다.

| Schema | Table | 책임 | 대표 Root |
|---|---:|---|---|
| `governance` | 20 | 사용자 Mandate, 전사 Case, 위원회, 승인, 자본 | `cases`, `mandates` |
| `workforce` | 20 | Agent 조직, Profile Version, Skill, Tool 권한, 채용·평가, 자기 개선 후보, Access Lifecycle | `agent_profiles` |
